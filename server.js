...
var useDataFilesToSessionData = process.env.USE_DATA_FILES_TO_SESSION_DATA || config.useDataFilesToSessionData
var dataFilesToSessionDataLiveReload = process.env.DATA_FILES_TO_SESSION_DATA_LIVE_RELOAD || config.dataFilesToSessionDataLiveReload
...
// Add data from data-files directory to session
if (useDataFilesToSessionData === 'true') {
  const doLiveReload = (dataFilesToSessionDataLiveReload === 'true')
  const dataFilesToSessionData = utils.dataFilesToSessionDataFactory({ prioritiseFileData: doLiveReload })
  app.use(dataFilesToSessionData)
}
